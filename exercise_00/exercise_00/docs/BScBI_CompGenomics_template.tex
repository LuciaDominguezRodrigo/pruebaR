...
%
% A function to protect raw MarkDown embed figures
% and to force them to fit into a page.
\makeatletter
...
\def\thylogo{\phantom{x}\raisebox{-2mm}{\includegraphics[height=6.5mm, width=6.5mm]{{docs/FIBUPC_logo}.png}}} %%% FIX %%%
%
...
\includegraphics[height=1.5cm, width=5cm]{{docs/FIBUPC_logo}.png}
& %
\shortstack{%
\textbf{\textsc{\large Computational Genomics 2025--26}}\\[1ex]
...
{\large \href{https://www.upc.edu/en/bachelors/bioinformatics-interuniversity-upc-ub-uab-upf-degree-barcelona-fib-etsetb}{UPC} -- \href{https://web.ub.edu/en/web/estudis/w/bachelordegree-g1134}{UB} -- \href{https://www.uab.cat/web/estudiar/ehea-degrees/general-information/bioinformatics-uab/upc/ub/upf-1216708259085.html?param1=1345910563150}{UAB} --  \href{https://www.upf.edu/en/web/biomed/graus}{UPF}}%
}%shortstack
\\[2ex]
\end{tabular}
%\end{raggedright}
